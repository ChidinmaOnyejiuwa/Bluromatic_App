...
class WorkerInstrumentationTest {
    ...
    private val mockUriInput: Pair<String, String> =
        KEY_IMAGE_URI to "android.resource://com.practice.bluromatic/drawable/cupcake"
    ...
    fun blurWorker_doWork_resultSuccessReturnsUri() {
        ...
        runBlocking {
            ...
            assertTrue(
                resultUri?.startsWith("file:///data/user/0/com.practice.bluromatic/files/blur_filter_outputs/blur-filter-output-")
                    ?: false
            )
        }
